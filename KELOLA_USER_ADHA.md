...
```css
/* Primary Green */
--green-primary: #22c55e --green-dark: #16a34a --green-darker: #15803d
  /* Action Colors */ --info-cyan: #0dcaf0 --warning-yellow: #fbbf24
  --danger-red: #ef4444 /* Role Badge Colors */ --admin-purple: #667eea →
  #764ba2 (gradient) --mahasiswa-cyan: #0dcaf0 → #0aa2c0 (gradient)
  /* Dark Theme */ --bg-dark-1: #2d3748 --bg-dark-2: #1a202c;
```
